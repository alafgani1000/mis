...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['role:staf']], function () {
        Route::get('request/{request}/status/edit','RequestController@updateview')->name('updateview.view');
        Route::put('request/{request}/status/update','RequestController@updatestatus')->name('updatestatus.action');
    });
...
Route::group(['middleware' => 'signedurl'], function () {
    Route::get('request/{request}/boss/form/{user}','RequestController@bossview')->name('boss.view.urlsigned');
    Route::get('request/{request}/spt/form/{user}','RequestController@sptview')->name('spt.view.urlsigned');
    Route::get('request/{request}/mgr/form/{user}','RequestController@mgrview')->name('mgr.view.urlsigned');
    Route::get('request/urlsigned/{user}','RequestController@index')->name('index.urlsigned');
});