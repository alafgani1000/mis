...
<!-- Content Header (Page header) -->
  <section class="content-header">
    <h1>
      FORM PERSETUJUAN SUPERITENDENT MIS
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
        <form role="form" method="POST" action="{{ route('spt.approve', $request->id) }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-11">
                        <label>Permintaan data dari {{ $request->user->name }} ({{ $request->user->id }}) telah disetujui oleh {{ $requestApproval->user->name }} ({{ $requestApproval->user->id }}.) <br/>
