      ...
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">FORM PERSETUJUAN PERMINTAAN DATA</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="row">
                    <br/>
                    <div class="col-md-11">
                        <button type="button" class="btn btn-primary btn-sm id-modal">Approve</button>
                        <button type="button" class="btn btn-primary btn-sm id-modal">Reject</button>
                    </div>
                </div>
              </div>
          </form>
